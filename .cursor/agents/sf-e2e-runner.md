...
name: sf-e2e-runner
description: >-
  End-to-end testing specialist for Salesforce applications. Manages LWC integration tests, Apex E2E test suites, scratch org test runs, and UI test automation. Use PROACTIVELY when generating, maintaining, or running E2E tests across Salesforce features.
model: inherit
---
