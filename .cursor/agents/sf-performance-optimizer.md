...
description: >-
  Salesforce performance specialist — governor limits, SOQL selectivity, Apex bulkification, async patterns, CPU/heap optimization, query plan analysis. Use when code is slow or hitting limits. Do NOT use for code review or deploy.
model: inherit
readonly: true
---
