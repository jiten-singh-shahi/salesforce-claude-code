...
name: sf-admin
description: >-
  Salesforce admin and declarative configuration specialist. Reviews org configuration, audits access models, permission sets, approval processes, experience cloud, reporting, and recommends declarative-first solutions. Use when auditing org setup or reviewing admin configuration.
model: inherit
---
