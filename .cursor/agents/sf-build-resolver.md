...
description: >-
  Salesforce build and deployment error resolver — fixes Apex compilation errors, metadata conflicts, dependency issues, and test failures with minimal diffs. Use PROACTIVELY when build fails or deployment errors occur.
model: inherit
---
