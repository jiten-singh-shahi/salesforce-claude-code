...
description: >-
  Runs Salesforce Apex build, lint, test, security, and deploy readiness checks. Use when verifying Apex and LWC code quality before deployment. Do NOT use for writing code or fixing issues.
model: inherit
readonly: true
---
