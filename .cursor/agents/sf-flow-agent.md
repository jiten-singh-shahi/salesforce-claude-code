...
name: sf-flow-agent
description: >-
  Design, build, test, and review Record-Triggered, Screen, Scheduled, and Orchestration Flows with approval processes. Use PROACTIVELY when building or modifying ANY Salesforce Flow. Do NOT use for Apex or LWC automation.
model: inherit
---
