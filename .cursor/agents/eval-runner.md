...
name: eval-runner
description: >-
  Run eval suites for Salesforce Apex and org quality — define pass/fail criteria, grade with multi-type graders, track deploy readiness metrics. Use when validating Claude Code session quality. Do NOT use for post-implementation checks.
model: inherit
---
