...
description: >-
  Dead code cleanup and consolidation specialist — uses PMD, sfdx-scanner for detection, removes unused code with safety tiers (SAFE/CAREFUL/RISKY). Use PROACTIVELY for removing unused Apex, duplicate logic, and dead metadata.
model: inherit
---
