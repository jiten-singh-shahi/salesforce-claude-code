...
name: sf-tdd-guide
description: >-
  Use when writing new Apex classes, triggers, or LWC components test-first — enforces Red-Green-Refactor with meaningful assertions and 75%+ coverage. Do NOT use for fixing existing failing tests; use sf-build-resolver instead. Keywords: TDD, Apex testing, LWC Jest, test-first, coverage, TestDataFactory.
model: inherit
---
