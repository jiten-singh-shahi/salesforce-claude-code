...
name: sf-tdd-guide
description: >-
  Test-Driven Development specialist for Salesforce. Enforces write-tests-first for Apex (75%+ coverage, meaningful assertions) and Jest-first for LWC. Use when writing new Apex classes, triggers, or LWC components.
model: inherit
---
