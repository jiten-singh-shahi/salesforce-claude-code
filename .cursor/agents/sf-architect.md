...
name: sf-architect
description: >-
  Analyze requirements, design metadata-driven Apex and LWC solutions, decompose into parallel tasks, enforce TDD, run final quality review. Use PROACTIVELY when planning ANY Salesforce feature. Do NOT use for writing code.
model: inherit
readonly: true
---
