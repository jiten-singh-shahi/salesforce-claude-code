...
description: >-
  Comprehensive Salesforce code reviewer covering Apex, LWC, SOQL, and declarative automation. Use after writing or modifying any Salesforce code or configuration.
model: inherit
---
