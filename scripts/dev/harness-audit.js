...
function getChecks() {
  ...
  return [
    ...
    },
    {
      ...
      pass: fileExists('agents/eval-runner.md') && fileExists('agents/sf-verification-runner.md') && fileExists('skills/checkpoint/SKILL.md'),
      fix: 'Add eval-runner/sf-verification-runner agents and checkpoint skill to standardize verification loops.',
    },
    {
