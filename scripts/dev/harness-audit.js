...
function getChecks() {
  ...
  return [
    ...
    },
    {
      ...
      scopes: ['repo', 'skills'],
      path: 'skills/eval-harness/SKILL.md',
      description: 'Eval and verification skills exist',
      pass: fileExists('skills/eval-harness/SKILL.md') && fileExists('skills/verification-loop/SKILL.md') && fileExists('skills/checkpoint/SKILL.md'),
      fix: 'Add eval-harness/checkpoint/verification-loop skills to standardize verification loops.',
    },
    {
    ...
    },
    {
      ...
      points: 3,
      scopes: ['repo', 'agents'],
      path: 'agents/sf-security-reviewer.md',
      description: 'Security reviewer agent exists',
      pass: fileExists('agents/sf-security-reviewer.md'),
      fix: 'Add agents/sf-security-reviewer.md for delegated security audits.',
    },
    {
