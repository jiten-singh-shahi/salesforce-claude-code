...
function usage() {
  console.log([
    'Usage:',
    '  node scripts/dev/orchestration-status.js <session-name|plan.json> [--write <output.json>]',
    '',
    'Examples:',
    '  node scripts/dev/orchestration-status.js workflow-visual-proof',
    '  node scripts/dev/orchestration-status.js .claude/plan/workflow-visual-proof.json',
    '  node scripts/dev/orchestration-status.js .claude/plan/workflow-visual-proof.json --write /tmp/snapshot.json'
  ].join('\n'));
}
