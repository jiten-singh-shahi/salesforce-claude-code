...
description: Salesforce data model architect covering custom object design, relationship types, schema optimization, Custom Metadata Types, External Objects, and data migration strategies. Use when designing data models or planning schema changes.
