...
description: Salesforce trigger framework specialist. Designs and refactors triggers to enterprise patterns (FFLIB or One-Trigger-Per-Object handler framework). Ensures proper bulkification, recursion prevention, and bypass mechanisms. Use when creating or refactoring triggers.
