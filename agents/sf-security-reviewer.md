...
description: >-
  Reviews Salesforce Apex and LWC for CRUD/FLS enforcement, sharing model,
  SOQL injection, and XSS prevention. Use when auditing Salesforce security
  before deployment. Do NOT use for general code review or performance.
