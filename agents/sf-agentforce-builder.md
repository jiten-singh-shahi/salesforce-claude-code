...
description: "Use when building Salesforce Agentforce AI agents — custom Apex actions (@InvocableMethod), topics, instructions, and Prompt Templates. Do NOT use for standard Apex/LWC work."
