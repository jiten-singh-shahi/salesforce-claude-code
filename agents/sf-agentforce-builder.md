...
description: Salesforce Agentforce AI agent development specialist. Designs and builds Agentforce agents with custom actions (Apex, Flow, Prompt Templates), topics, instructions, and testing strategies. Use when building AI-powered Salesforce agents.
