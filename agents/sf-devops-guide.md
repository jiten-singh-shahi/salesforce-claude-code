...
description: Salesforce DevOps specialist covering SF CLI v2, scratch org development, CI/CD pipelines (GitHub Actions), sandbox management, and deployment strategies. Use for DevOps setup, CI/CD configuration, and deployment workflows.
