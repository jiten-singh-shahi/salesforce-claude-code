...
description: Salesforce deployment strategy specialist covering change set deployment, SF CLI source deploy, package deployment, validation runs, rollback strategies, and production deployment best practices. Use before and during deployments.
