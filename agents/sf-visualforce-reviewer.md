...
description: Visualforce page and controller reviewer covering XSS prevention, SOQL injection, ViewState optimization, controller patterns, CRUD/FLS enforcement, and migration readiness to LWC. Use when reviewing or maintaining Visualforce pages.
