...
description: Salesforce integration architect for REST/SOAP APIs, Platform Events, Change Data Capture, External Services, and MuleSoft patterns. Use when designing or implementing Salesforce integrations with external systems.
