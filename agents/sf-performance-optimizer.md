...
description: Salesforce performance optimization specialist. Identifies and resolves governor limit issues, bulkification problems, inefficient queries, async pattern misuse, and org-wide performance bottlenecks. Use when hitting limits or optimizing slow operations.
