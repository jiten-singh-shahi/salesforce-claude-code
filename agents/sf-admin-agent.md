...
name: sf-admin-agent
description: >-
  Configure Salesforce org — custom objects, permissions, sharing model,
  Custom Metadata, Experience Cloud, and scratch orgs. Use PROACTIVELY when
  setting up org configuration. Do NOT use for Apex, LWC, or Flow code.
