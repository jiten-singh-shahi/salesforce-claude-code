---
name: sf-planner
description: Expert Salesforce implementation planner for features, integrations, and architecture changes. Use PROACTIVELY when implementing new Salesforce features, data model changes, integrations, or complex refactoring.
