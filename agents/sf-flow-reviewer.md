...
description: Salesforce Flow and declarative automation reviewer. Reviews Screen Flows, Record-Triggered Flows, Scheduled Flows, and Autolaunched Flows for performance, governor limits, error handling, and best practices. Use when building or reviewing Flows.
