...
description: >-
  Use when building or reviewing Salesforce Record-Triggered, Screen, or
  Scheduled Flows for performance, governor limits, and error handling best
  practices. Do NOT use for Apex automation or LWC.
