...
description: >-
  Build and review Salesforce integrations — REST/SOAP callouts, Named
  Credentials, Platform Events, CDC, and External Services. Use PROACTIVELY
  when building integrations. Do NOT use for internal Apex logic or LWC.
